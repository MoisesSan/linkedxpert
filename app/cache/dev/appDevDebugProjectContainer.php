...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'security.user_checker.frontend' => 'getSecurity_UserChecker_FrontendService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'xpertcad2016', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\nctech\\usuariosBundle\\Entity'))), 'nctech\\usuariosBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('usuariosBundle' => 'nctech\\usuariosBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_096fce053b25d05bb3c8012cc79ea06a8bb8ca0ec5295d975b8af4f537830427');
     ...
     * This method always returns the same instance of the service.
     *
     * @return \nctech\usuariosBundle\Listener\LoginListener A nctech\usuariosBundle\Listener\LoginListener instance.
     */
    protected function getLoginListenerService()
    {
        return $this->services['login_listener'] = new \nctech\usuariosBundle\Listener\LoginListener($this->get('security.context'), $this->get('router'));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('nctech\\usuariosBundle\\Entity\\LxUsers' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\PlaintextPasswordEncoder', 'arguments' => array(0 => false))));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.frontend' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/*'))), $this->get('debug.event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_FrontendService()
    {
        ...
        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/usuarios/login');

        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/usuarios/registro');

        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/usuarios/*');

        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/fe/*');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/be/*');
        ...
        $m->add($j, array(0 => 'ROLE_USUARIO'), NULL);
        $m->add($k, array(0 => 'ROLE_USUARIO'), NULL);
        $m->add($l, array(0 => 'ROLE_USUARIO'), NULL);

        $n = new \Symfony\Component\Security\Http\HttpUtils($e, $e);

        $o = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), 'linkedxpert2016', 'frontend', array('lifetime' => 3600, 'name' => 'REMEMBERME', 'path' => '/', 'domain' => NULL, 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);

        $p = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $n, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($n, '/'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'usuarios_logout'));
        $p->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());
        $p->addHandler($o);

        $q = new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate');

        $r = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($n, array());
        $r->setOptions(array('login_path' => 'usuarios_login', 'default_target_path' => '/fe', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $r->setProviderKey('frontend');

        $s = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($f, $n, array(), $a);
        $s->setOptions(array('login_path' => 'usuarios_login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        $t = new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $g, $q, $n, 'frontend', $r, $s, array('check_path' => 'usuarios_login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $d, NULL);
        $t->setRememberMeServices($o);

        return $this->services['security.firewall.map.context.frontend'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($m, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $c), 'frontend', $a, $d), 2 => $p, 3 => $t, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($b, $o, $g, $a, $d, true, $q), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '56eaf22abe4931.13781508', $a, $g), 6 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $m, $g)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $n, 'frontend', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $n, 'usuarios_login', false), NULL, NULL, $a, false));
    }
    ...
    /**
     * Gets the 'security.user_checker.frontend' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSecurity_UserChecker_FrontendService()
    {
        return $this->services['security.user_checker.frontend'] = new \Symfony\Component\Security\Core\User\UserChecker();
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\nctech\\feBundle/Resources/views'), 'fe');
        $instance->addPath(($this->targetDirs[3].'\\src\\nctech\\beBundle/Resources/views'), 'be');
        $instance->addPath(($this->targetDirs[3].'\\src\\nctech\\usuariosBundle/Resources/views'), 'usuarios');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('ksr010377masg110377lxssosss201');
    }
    ...
    {
        $a = $this->get('security.user_checker.frontend');

        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('security.user.provider.concrete.usuarios'), $a, 'frontend', $this->get('security.encoder_factory'), true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\RememberMeAuthenticationProvider($a, 'linkedxpert2016', 'frontend'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56eaf22abe4931.13781508')), true);
    ...
    protected function getSecurity_LogoutUrlGeneratorService()
    {
        ...
        $instance->registerListener('frontend', 'usuarios_logout', 'logout', '_csrf_token', NULL);
    ...
    {
        return $this->services['security.user.provider.concrete.usuarios'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'nctech\\usuariosBundle\\Entity\\LxUsers', 'useremail', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'feBundle' => 'nctech\\feBundle\\feBundle',
                'beBundle' => 'nctech\\beBundle\\beBundle',
                'usuariosBundle' => 'nctech\\usuariosBundle\\usuariosBundle',
            ...
            'locale' => 'en',
            'secret' => 'ksr010377masg110377lxssosss201',
            ...
            'kernel.secret' => 'ksr010377masg110377lxssosss201',
